//
//  XLBMainDynamicViewController.m
//  xiaolaba
//
...
@interface XLBMainDynamicViewController ()<UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate,MainMomentsCellDelegate,XLBErrorViewDelegate,XLBShareViewDelegate>
...
@implementation XLBMainDynamicViewController
...
- (void)loginSuccess {
    [[NetWorking network] POST:kCallContent params:nil cache:NO success:^(id result) {
        [[NSUserDefaults standardUserDefaults] setObject:result[0] forKey:@"CallPhoneDict"];
        [[NSUserDefaults standardUserDefaults]  synchronize];
        [[NSNotificationCenter defaultCenter] postNotificationName:@"AddAdressBook" object:nil];
    }failure:^(NSString *description) {
    }];
}
