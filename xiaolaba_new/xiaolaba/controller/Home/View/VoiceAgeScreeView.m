...
#define CenterImage_W       38.0

#define LiuXSliderLine_W    (LiuXSlideWidth-CenterImage_W)
#define LiuXSLiderLine_H    2.0
...
@implementation VoiceAgeScreeView
...
-(instancetype)initWithFrame:(CGRect)frame titles:(NSArray *)titleArray firstAndLastTitles:(NSArray *)firstAndLastTitles defaultIndex:(CGFloat)defaultIndex sliderImage:(UIImage *)sliderImage
{
    if (self  = [super initWithFrame:frame]) {
        ...
        _defaultView.backgroundColor=[UIColor textBlackColor];
        ...
        _selectView.backgroundColor=[UIColor textBlackColor];
...
//        _centerImage.alpha=.5;
        ...
        _selectLab=[[UILabel alloc] initWithFrame:CGRectMake(0, CenterImage_Y + 20, 80, 30)];
...
-(void)setFirstAndLastTitles:(NSArray *)firstAndLastTitles{
    _leftLab=[[UILabel alloc] initWithFrame:CGRectMake(0, CenterImage_Y + 10, 80, LiuXSliderTitle_H)];
    ...
    _rightLab=[[UILabel alloc] initWithFrame:CGRectMake(LiuXSlideWidth-80, CenterImage_Y + 10, 80, LiuXSliderTitle_H)];
...
-(void)refreshSlider{
    ...
    if (_sectionIndex==0) {
        _leftLab.hidden=YES;
        _rightLab.hidden = NO;
        _selectLab.center=CGPointMake(_pointX, CenterImage_Y + 30);
