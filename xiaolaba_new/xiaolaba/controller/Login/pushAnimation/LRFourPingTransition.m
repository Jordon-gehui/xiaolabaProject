...
- (void)presentAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    //画圆
    UIBezierPath *startCycle = [UIBezierPath bezierPathWithOvalInRect:CGRectMake(kSCREEN_WIDTH/2.0-5, kSCREEN_HEIGHT/2.0-5, 10, 10)];
    CGFloat x = MAX(kSCREEN_WIDTH/2.0-5, containerView.frame.size.width - 10);
    CGFloat y = MAX(kSCREEN_HEIGHT/2.0-5, containerView.frame.size.height - 10);
