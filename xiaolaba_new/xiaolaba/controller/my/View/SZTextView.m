...
- (void)preparePlaceholder
{
    ...
    //CGRect temp = CGRectMake(10, frame.origin.y, frame.size.width - 20, frame.size.height);
    ...
    //self.contentInset = UIEdgeInsetsMake(0, 10.0f, 0, 10.0f);
    //self.textContainerInset = UIEdgeInsetsMake(8.f, 10.0f, 8.f, 10.0f);
}
...
- (void)resizePlaceholderFrame
{
    ...
    //self._placeholderTextView.frame = CGRectMake(10, 0, frame.size.width - 20, frame.size.height);
}
