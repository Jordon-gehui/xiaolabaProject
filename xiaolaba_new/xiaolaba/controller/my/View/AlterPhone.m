...
-(void)initializer {
    _hintL = [UILabel new];
    _hintL.font = [UIFont systemFontOfSize:16.0];
    ...
    [_sendBtn setTitleColor:[UIColor lightColor] forState:UIControlStateNormal];
    [_sendBtn setTitleColor:[UIColor lightColor] forState:UIControlStateHighlighted];
    [_sendBtn setTitleColor:[UIColor lightColor] forState:UIControlStateDisabled];
