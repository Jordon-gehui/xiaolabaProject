//
//  XLBAccountHelpViewController.m
//  xiaolaba
//
...
#import "XLBAccountHelpViewController.h"

@interface XLBAccountHelpViewController ()
@property (nonatomic,retain)UILabel *tipL;
@property (nonatomic,retain)UILabel *contentL;
@end

@implementation XLBAccountHelpViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"帮助";
    self.naviBar.slTitleLabel.text = @"帮助";
