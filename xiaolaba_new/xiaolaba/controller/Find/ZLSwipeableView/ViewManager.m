...
- (void)handlePan:(UIPanGestureRecognizer *)recognizer {
    ...
    if (recognizer.state == UIGestureRecognizerStateEnded ||
        ...
        NSLog(@"%li,%li",_swipeableView.allData.count,_swipeableView.allindex);
//
        ...
        if ([_swipeableView.swipingDeterminator shouldSwipeView:_view
                                                       movement:movement
                                                  swipeableView:_swipeableView]&&!(_swipeableView.allData.count==_swipeableView.allindex+1&&directionVector.dx<0)&&!(_swipeableView.allindex==0&&directionVector.dx>0)) {
